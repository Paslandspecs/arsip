          ...
          <div class="col-lg-7">
            ...
            <!-- <div class="card card-primary card-outline">
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <?php 
                    $file_extension = pathinfo($arsip->file, PATHINFO_EXTENSION);

                    if ($file_extension == 'pdf') { ?>
                        <div id="pdf-container">
                            <iframe src="<?= base_url('upload/file/' . $arsip->file) ?>" width="100%" height="500px"></iframe>
                        </div>
                    <?php 
                    } elseif (in_array($file_extension, ['jpg', 'jpeg', 'png'])) { ?>
                        <div id="image-container">
                            <img src="<?= base_url('upload/file/' . $arsip->file) ?>" alt="Preview" style="max-width: 100%; height: auto;">
                        </div>
                   
                    <?php 
                    } else { ?>
                        <p># Format file ini tidak dapat ditampilkan sebagai pratinjau. ( dengan tipe 'doc', 'docx', 'xls', 'xlsx', 'txt')</p>
                    <?php } ?>
                </div>
