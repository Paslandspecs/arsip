...
<footer class="main-footer">
    ...
    <!-- Default to the left -->
    <!-- Copyright &copy; <?= date('Y') ?> <a href="<?= base_url('') ?>"><?= $list->title ?></a>. All rights reserved. -->
    Copyright &copy; <?= date('Y') ?> <strong style="color: blue;">Ahmad Nawawi</strong> . All rights reserved.
